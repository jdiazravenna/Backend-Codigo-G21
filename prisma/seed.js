// aqui colocamos la informacion predeterminada en nuestra BD
...
async function poblarBD(){
    const equipos = [
      ...
      for (const equipo of equipos){
        // Las condiciones de la clausula Where, solamente se puede usar las columnas que tengan
        // unicidad, o q sea llave primaria
...
poblarBD().then(()=>{
    console.log("El proceso, fue ralizdo con exito")
})
.catch((e) =>{
